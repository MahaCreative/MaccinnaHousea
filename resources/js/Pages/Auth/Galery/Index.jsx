...
export default function Index(props) {
    ...
    const deleteHandler = (id) => {
        ResponseMethode(
            ...
            () => {
                router.delete(route("auth.delete-data-galery", { id }), {
                    onSuccess: () =>
                        showResponse(
                            "success",
                            "Suksess",
        ...
        <div className="px-4 md:px-8 lg:px-16 usetTransition py-7 ">
            <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <div className="w-full">
                            ...
                            >
                                <div className="flex justify-between  items-center px-4 py-1">
                                    <h3 className="tracking-tighter font-light text-blue800 text-lg">
                                        Data Galery
                                    </h3>
                                </div>
                                <TableLayout>
                ...
                {auth.user.role == "admin" && (
                    <div className="w-full">
                        <h3 className="text-blue800">Tambahkan Galery Baru</h3>
